    ...
    <div class="block md:flex flex-1 flex-wrap">
        <div class="flex-1 bg-neutral-300 dark:bg-neutral-700 border-1 p-8 h-screen" style="background-position: center; background-image: url('{{ glide :src="left_background" width="1920" height="1080" fit="crop_focal" }}')">
            <div class="w-full lg:w-3/4 mx-auto">
                ...
                <form method="POST" action="/forgot-password" class="bg-white dark:bg-neutral-500 shadow-md p-8 text-gray-700 dark:text-white">
                    <?php
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="w-1/3 px-2 py-3 text-white bg-black rounded-full hover:bg-gray-900 focus:outline-none text-sm focus:ring focus:ring-gray-200 focus:ring-opacity-50">
                            Submit
                        </button>
                    </div>
                </form>
        ...
        <div class="flex-1 p-8 border-gray-100 h-screen" style="background-position: center; background-image: url('{{ glide :src="right_background" width="1920" height="1080" fit="crop_focal" }}')">
        <div class="w-full lg:w-3/4 mx-auto">
            <div class="text-left h-16"></div>
                    ...
                    <div class="text-left mb-4">
                        <ul class="list-unstyled text-gray-700 dark:text-white text-sm">
                            <li class="border-b py-3 flex items-center gap-8">
                                ...
                                <span>{{ account_benefits[0] ?? "Save your billing and delivery information to order faster" }}</span>
                            </li>
                            <li class="border-b py-3 flex items-center gap-8">
                                <div>
                                ...
                                <span>{{ account_benefits[1] ?? "Access your session & order history" }}</span>
                            </li>
                            <li class="border-b py-3 flex items-center gap-8">
                                <div>
                                ...
                                <span>{{ account_benefits[2] ?? "Receive the latest news and updates on our promotional or educational materials" }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
